...
class FBEmptyAudienceCreate():
    ...
    def _execute(self) -> None:
        fb_utils.create_empty_custom_audience_create(self._params['account_id'], self._params['app_id'], self._params['app_secret'], self._params['access_token'], self._params['audience_name'], self._params['audience_description'])